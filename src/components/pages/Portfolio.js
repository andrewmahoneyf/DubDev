            ...
            <section className="portfolio bg-light">
                ...
                <div className="album pb-5 bg-light">
                    <div className="container-fluid">
                        <div className="row">
                            <div className="col-md-6 col-lg-4 animated fadeInLeft">
                            ...
                            <div className="col-md-6 col-lg-4 animated zoomIn">
                                <div className="card mb-4 box-shadow zoom">
                            ...
                            <div className="col-md-6 col-lg-4 animated fadeInRight">
                                <div className="card mb-4 box-shadow zoom">
