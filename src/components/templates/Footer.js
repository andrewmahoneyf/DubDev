          ...
          <div className="col-12 col-md-4 col-lg-6 text-white">
            ...
            <div className="row pt-2">
              <div className="col-6 col-md-4 col-lg-6 text-right">
                <a href="https://www.linkedin.com/company/dubdev/" target="_blank" rel="noopener noreferrer">
                  <i className="fa fa-linkedin d-md-none d-lg-inline-block" aria-label="linkedIn logo" />
                </a>
                <a href="mailto:info@dubdev.com" target="_blank" rel="noopener noreferrer">
                  <i className="fa fa-envelope" aria-label="email" />
                </a>
              </div>
