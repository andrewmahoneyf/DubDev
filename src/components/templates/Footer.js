      ...
      <footer className="container-fluid pt-4 pb-2">
        <div className="row" id="contact">
          <div className="col-12 col-md-4 text-white">
            <a className="row pl-3" href="#top" onClick={Scroll.animateScroll.scrollToTop()}>
            ...
            <h1 className="pt-2 pt-md-5 mt-md-4">Contact Us</h1>
            <p>In need of a new website? Tell us about your project and we will send you a timeline along with our quote.</p>
        ...
        <div className="row">
          <div className="col-12 col-md pt-3">
            <small className="d-block text-white copyright">&copy; DubDev 2017-2018</small>
