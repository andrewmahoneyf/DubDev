  ...
  render() {
    return (
      <nav className="navbar navbar-expand-md fixed-top site-header py-1 transparent box-shadow" data-toggle="collapse" data-target="#navbarSupportedContent">
        <a className="py-2 pl-3 banner"><img className="logo" src={logo} alt="logo" width="98.2" height="24.7"/></a>
        ...
        <div className="collapse navbar-collapse pr-3" id="navbarSupportedContent">
          <ul className="navbar-nav mr-auto text-right pl-2">
            <li className="nav-item pt-md-1">
              <Link className="py-2d-md-inline-block nav-link" to={routes.LANDING}>Home</Link>
            </li>
            <li className="nav-item pt-md-1">
