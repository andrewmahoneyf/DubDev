        ...
        return (
            <div>
                ...
                <section className="privacy bg-light pb-5">
                    <h2 id="ppHeader" className="pt-4">DubDev Privacy Policy</h2><br />
                    <div className="container text-left">
                        ...
                        <strong> ALL </strong> correspondence.</div><br />
