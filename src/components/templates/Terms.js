    ...
    render() {
        return (
            <div>
                ...
                <section className="terms bg-light pb-5">
                    <h2 className="pt-4">DubDev Terms of Service</h2>
                    <div className="container text-left">
                        <h3>1. Terms</h3>
                        <p>By accessing the website at <a href="http://dubdev.com">http://dubdev.com</a>, you are
                        ...
                        <ol type="a">
                            ...
                            (information or software) on Big's Contracting Agency's website for personal,
                            ...
                            <ol type="i">
                                    ...
                                    <li>attempt to decompile or reverse engineer any software contained on Big's
                                    Contracting Agency's website;</li>
                            ...
                            restrictions and may be terminated by Big's Contracting Agency at any time. Upon
                        ...
                        <h3>3. Disclaimer</h3>
                        <ol type="a">
                            <li>The materials on Big's Contracting Agency's website are provided on an 'as
                            is' basis. Big's Contracting Agency makes no warranties, expressed or implied,
                            ...
                            violation of rights.</li>
                            <li>Further, Big's Contracting Agency does not warrant or make any
                            representations concerning the accuracy, likely results, or reliability of the
                            use of the materials on its website or otherwise relating to such materials or
                            on any sites linked to this site.</li>
                        </ol>
                        <h3>4. Limitations</h3>
                        <p>In no event shall Big's Contracting Agency or its suppliers be liable for any
                        ...
                        materials on Big's Contracting Agency's website, even if Big's Contracting
                        Agency or a Big's Contracting Agency authorized representative has been notified
                        ...
                        <p>The materials appearing on Big's Contracting Agency website could include
                        technical, typographical, or photographic errors. Big's Contracting Agency does
                        not warrant that any of the materials on its website are accurate, complete or
                        current. Big's Contracting Agency may make changes to the materials contained on
                        its website at any time without notice. However Big's Contracting Agency does
                        not make any commitment to update the materials.</p>
                        <h3>6. Links</h3>
                        <p>Big's Contracting Agency has not reviewed all of the sites linked to its
                        website and is not responsible for the contents of any such linked site. The
                        inclusion of any link does not imply endorsement by Big's Contracting Agency of
                        the site. Use of any such linked website is at the user's own risk.</p>
                        <h3>7. Modifications</h3>
                        <p>Big's Contracting Agency may revise these terms of service for its website at
                        any time without notice. By using this website you are agreeing to be bound by
