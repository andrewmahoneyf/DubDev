                ...
                <section className="terms bg-light pb-5">
                    ...
                    <div className="container text-left">
                        ...
                        <ol type="a">
                            ...
                            (information or software) on DubDev's website for personal,
                            ...
                            restrictions and may be terminated by DubDev at any time. Upon
                        ...
                        <h3>3. Disclaimer</h3>
                        <ol type="a">
                            <li>The materials on DubDev's website are provided on an 'as
                            is' basis. DubDev makes no warranties, expressed or implied,
                            ...
                            <li>Further, DubDev does not warrant or make any
                        ...
                        <h3>4. Limitations</h3>
                        <p>In no event shall DubDev or its suppliers be liable for any
                        ...
                        materials on DubDev's website, even if Big's Contracting
                        Agency or a DubDev authorized representative has been notified
                        ...
                        <p>The materials appearing on DubDev website could include
                        technical, typographical, or photographic errors. DubDev does
                        not warrant that any of the materials on its website are accurate, complete or
                        current. DubDev may make changes to the materials contained on
                        its website at any time without notice. However DubDev does
                        not make any commitment to update the materials.</p>
                        <h3>6. Links</h3>
                        <p>DubDev has not reviewed all of the sites linked to its
                        website and is not responsible for the contents of any such linked site. The
                        inclusion of any link does not imply endorsement by DubDev of
                        the site. Use of any such linked website is at the user's own risk.</p>
                        <h3>7. Modifications</h3>
                        <p>DubDev may revise these terms of service for its website at
